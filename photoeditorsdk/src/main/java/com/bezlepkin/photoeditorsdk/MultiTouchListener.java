...
class MultiTouchListener implements OnTouchListener {
    ...
    MultiTouchListener(View deleteView, RelativeLayout parentView, ImageView photoEditImageView, OnPhotoEditorSDKListener onPhotoEditorSDKListener) {
        ...
        switch (action & event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isViewInBounds(deleteView, x, y)) {
                    ...
                    // TODO: удаления при перетаскивании imageView для режима текста
                ...
                if (mCurrentCancelX == mPrevRawX || mCurrentCancelY == mPrevRawY) {
                    // TODO: странная штука которая удаляет textView при перетаскивании
